...
abstract class Plan {
    ...
    long deductible;
    //create new objects from RangeCriterion class
    RangeCriterion customerAgeCriterion = new RangeCriterion();
    RangeCriterion customerIncomeCriterion = new RangeCriterion();

    //get these variable from tags
    Plan(HashMap<String, Tag> tags) {
        //call methods in tags to get variable and convert to int if necessary
        ...
        //if there is such a customer add the age and income to the two objects
